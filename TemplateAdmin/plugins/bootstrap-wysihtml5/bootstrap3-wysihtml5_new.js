        ...
        "image": function(locale, options) {
            ...
            return "<li>" +
                ...
                "<h4>Upload your image</h4>" +
				  "<form name='photo' id='imageUploadForm' enctype='multipart/form-data' action='UpLoadImg' method='post'>" +
                "<input type='file' class='hide' id='imageBrowse' name='image1' size='30'/>" +
